...
if (mejs.i18n.ca !== undefined) {
	// mejs.i18n.ca["mejs.time-skip-back"] = ["Skip back 1 second", "Skip back %1 seconds"];
}
if (mejs.i18n.cs !== undefined) {
	mejs.i18n.cs["mejs.time-skip-back"] = "Zpět o %1 vteřin";
}
...
if (mejs.i18n.hu !== undefined) {
	mejs.i18n.hu["mejs.time-skip-back"] = "Ugrás vissza %1 másodperccel";
}
if (mejs.i18n.it !== undefined) {
	mejs.i18n.it["mejs.time-skip-back"] = "Riavvolgere %1 secondi";
}
...
if (mejs.i18n.nl !== undefined) {
	mejs.i18n.nl["mejs.time-skip-back"] = "%1 seconden terug springen";
}
if (mejs.i18n.pl !== undefined) {
	mejs.i18n.pl["mejs.time-skip-back"] = ["Cofnij o sekundę", "Cofnij o %1 sekundy", "Cofnij o %1 sekund"];
}
if (mejs.i18n.pt !== undefined) {
	mejs.i18n.pt["mejs.time-skip-back"] = ["Retroceder %1 segundo", "Retroceder %1 segundos"];
}
if (mejs.i18n['pt-BR'] !== undefined) {
	//mejs.i18n['pt-BR']["mejs.time-skip-back"] = ["Skip back 1 second", "Skip back %1 seconds"];
}
if (mejs.i18n.ro !== undefined) {
	mejs.i18n.ro["mejs.time-skip-back"] = "Sari înapoi %1 secunde";
}
...
if (mejs.i18n.sk !== undefined) {
	mejs.i18n.sk["mejs.time-skip-back"] = "Preskočiť dozadu o %1 s.";
}
